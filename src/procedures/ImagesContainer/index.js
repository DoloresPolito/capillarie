...
const data = [
  {
    id:"1",
    title: "Platelet-Rich Plasma (PRP) therapy utilizes patient's own blood to stimulate hair growth and improve hair density.",
    benefits: [
  ...
  {
    id:"2",
    title: "Hair mesotherapy involves injecting a customized mixture of substances and medications directly into the scalp to enhance hair condition.",
    benefits: [
  ...
  {
    id:"3",
    title: "Antiandrogen drugs are effective in treating male androgenic alopecia by targeting the hair follicle root.",
    benefits: [
  ...
  {
    id:"4",
    title: "Minoxidil is a topical treatment used to stimulate hair thickening, available in liquid or foam forms.",
    benefits: [
...
const dataespañol = [
  {
    id: "1",
    title: "La terapia con Plasma Rico en Plaquetas (PRP) utiliza la propia sangre del paciente para estimular el crecimiento del cabello y mejorar la densidad del cabello.",
    benefits: [
  ...
  {
    id: "2",
    title: "La mesoterapia capilar implica inyectar una mezcla personalizada de sustancias y medicamentos directamente en el cuero cabelludo para mejorar la condición del cabello.",
    benefits: [
  ...
  {
    id: "3",
    title: "Los medicamentos antiandrógenos son efectivos para tratar la alopecia androgenética masculina al dirigirse a la raíz del folículo piloso.",
    benefits: [
  ...
  {
    id: "4",
    title: "Minoxidil es un tratamiento tópico utilizado para estimular el engrosamiento del cabello, disponible en forma líquida o en espuma.",
    benefits: [
    ...
    <ParallaxProvider>
      <div className={styles.maincontainer}>
        {currentData.map(({ title, benefits, additionalText, image, id, mobileimage }, index) => {
          ...
          return (
            <div
              className={`${styles.treatcontainer} ${isEven ? styles.even : styles.odd}`}
              key={index}
              id={id}
            >
